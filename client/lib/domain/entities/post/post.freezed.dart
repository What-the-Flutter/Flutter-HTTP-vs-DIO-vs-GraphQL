...
/// @nodoc
abstract class _$$_CreatePostModelCopyWith<$Res>
    implements $CreatePostModelCopyWith<$Res> {
  factory _$$_CreatePostModelCopyWith(
          _$_CreatePostModel value, $Res Function(_$_CreatePostModel) then) =
      __$$_CreatePostModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String userId,
...
/// @nodoc
class __$$_CreatePostModelCopyWithImpl<$Res>
    extends _$CreatePostModelCopyWithImpl<$Res, _$_CreatePostModel>
    implements _$$_CreatePostModelCopyWith<$Res> {
  __$$_CreatePostModelCopyWithImpl(
      _$_CreatePostModel _value, $Res Function(_$_CreatePostModel) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_CreatePostModel
    with DiagnosticableTreeMixin
    implements _CreatePostModel {
  const _$_CreatePostModel(
      {required this.userId,
      required this.authorName,
      required this.text,
      required this.title,
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'CreatePostModel'))
      ..add(DiagnosticsProperty('userId', userId))
      ..add(DiagnosticsProperty('authorName', authorName))
      ..add(DiagnosticsProperty('text', text))
      ..add(DiagnosticsProperty('title', title))
  ...
  _$$_CreatePostModelCopyWith<_$_CreatePostModel> get copyWith =>
      __$$_CreatePostModelCopyWithImpl<_$_CreatePostModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_CreatePostModelToJson(
      this,
    );
  }
}
